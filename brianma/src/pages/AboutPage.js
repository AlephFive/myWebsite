      ...
      <Container>
        ...
        <Row>
          ...
          <Col sm={6} style={{ textAlign: 'left' }}>
            ...
            <p>
              Aspiring software and hardware developer with experience in C++, C#, and Circuit
              Design for Human Computer Interaction, Hardware Prototyping and Design, with published
              research in a top ACM conference (TEI). Industry experience in Web-Front End
              ...
              and has contributions to an open source project used by a well-known company. Can
              thrive in both industry and academic research environments.
            </p>
            <p>
              In terms of interests, I hope to not define myself with any label or dicipline. I feel
              the most interesting things happen at the boundaries of diciplines, and I feel
              interdiciplinary work is great.....
            </p>
            <p>
