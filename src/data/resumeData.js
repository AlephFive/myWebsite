export const experiences = [
  {
    ...
    description: [
      "On a team supporting translators so stories around the world can be told without Cultural, Linguistic, and Accessibility barriers!",
    ],
...
export const skills = {
  ...
  arts: {
    proficient:
      "Figma, Basalmiq, Adobe XD, Illustrator, Photoshop, Premiere Pro",
